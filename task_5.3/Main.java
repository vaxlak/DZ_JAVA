...
public class Main {
    public static void main(String[] args) {
        Cat cat1=new Cat(5,3,100);
        Cat cat2=new Cat(5,3,100);
        //Первый кот напал на второго
        if(cat1.fight(cat2)) System.out.println("Победил кошак 1");
        else System.out.println("Победил кошак 2");
        //Второй кот напал на первого
        if(cat2.fight(cat1)) System.out.println("Победил кошак 2");
        else System.out.println("Победил кошак 1");
...
class Cat {
    ...
    public boolean fight(Cat anotherCat) {
        ...
        // если ничья - то побеждает нападавший. Надеюсь, я правильно понял задание
